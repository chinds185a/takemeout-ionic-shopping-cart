...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://scottsapp-48c59.firebaseio.com/"),
    refCart = new Firebase("https://scottsapp-48c59.firebaseio.com/cart"),
    refUser = new Firebase("https://scottsapp-48c59.firebaseio.com/users"),
    refCategory = new Firebase("https://scottsapp-48c59.firebaseio.com/category"),
    refOrder = new Firebase("https://scottsapp-48c59.firebaseio.com/orders"),
    refFeatured = new Firebase("https://scottsapp-48c59.firebaseio.com/featured"),
    refMenu = new Firebase("https://scottsapp-48c59.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
